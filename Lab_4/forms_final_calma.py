...
def define_rois(id, x, y, img, img_path):
    ...
    if id == 1:
        ...
        roi_1 = (x+650, y+150, 500, 175)
        roi_2 = (x+1200, y+150, 350, 175)
        roi_3 = (x+1600, y+150, 350, 175)
        roi_4 = (x+2000, y+150, 350, 175)
        roi_5 = (x+720, y+340, 450, 175)
...
def main(input_dir, output_dir=None):
    ...
    for arquivo in os.listdir(input_dir):
        ...
        if is_image(img_path):
            ...
            img_eroded = cv2.dilate(clean_img, kernel_dilate, iterations=1)
            ...
            x, y = define_threshold(img_dilated)
            print(x,y)

            if (isForm_1(img_path)):
                rois = define_rois(1, x, y, img_dilated, img_path)
            else:
                rois = define_rois(2, x, y, img_dilated, img_path)

            # Segmentar os formulários
            form_results = segment_form(img_dilated, rois, img_path, values)
