...
def define_rois():
    ...
    # x y w h
    roi_1 = (850, 760, 1560, 110)
    roi_11 = (850, 950, 1560, 100)
    roi_12 = (850, 1120, 1560, 110)
    roi_13 = (850, 1310, 1560, 110)
    roi_14 = (850, 1490, 1560, 110)
    roi_15 = (850, 1670, 1560, 80)
    ...
    for i in range(len(rois)):
        ...
        if i <= 5:
            ...
            for j in range(num_intervalos):
                ...
                max = np.argmax(histograma_cortado[inicio:fim])

                k = inicio
                while (k < fim):
                    dif = max - histograma_cortado[k]
                    k += 1
                    sum += dif
                larguras.append(sum)
