...
def define_rois_form_1():
    ...
    roi_0 = (850, 760, 1560, 120)
    roi_1 = (850, 950, 1560, 110)
    roi_2 = (850, 1120, 1560, 120)
    roi_3 = (850, 1310, 1560, 120)
    roi_4 = (850, 1490, 1560, 120)
    roi_5 = (850, 1670, 1560, 90)
    roi_6 = (850, 1770, 570, 200)
    roi_7 = (70, 2070, 600, 250)
    roi_8 = (1330, 2070, 700, 220)
    roi_9 = (900, 2290, 1480, 220)
