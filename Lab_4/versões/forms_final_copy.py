...
def define_rois(id, x, y, img, img_path):
    ...
    if id == 1:
        ...
        roi_7 = (x+722, y+1249, 600, 200)
        roi_8 = (x-90, y+1590, 580, 150)
        roi_9 = (x+1110, y+1600, 660, 120)
...
def scalar_question(histogram, img_path):
    ...
    for i in range(len(rois)):
        if i <= 5:
            ...
            if 6 <= i <= 8:
                ...
                result = scalar_question(histogram, img_path)
