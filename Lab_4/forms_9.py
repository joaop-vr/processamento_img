...
def define_rois():
    ...
    roi_3 = (70, 2160, 500, 150)
    roi_4 = (1330, 2170, 600, 120)
...
def calc_sums(histogram, num_intervals, interval_size):
    ...
    for j in range(num_intervals):
        ...
        inicio = j * interval_size
        fim = (j + 1) * interval_size

        count = np.sum(histogram[inicio:fim])
...
def calc_variations(histogram, num_intervals, interval_size):

    # Calcule a variância para cada intervalo no eixo X
    variâncias = []
    for i in range(num_intervals):
        inicio = i * interval_size
        fim = (i + 1) * interval_size
        sub_histograma = histogram[inicio:fim]
...
def segment_form(img_path, rois):
    ...
    for i in range(len(rois)):
        ...
        if i <= 5:
            ...
            variations = calc_variations(histograma_cortado, num_intervalos, intervalo_tamanho)
